...
@section('content')
    <div class="mobile-container">
            ...
            <h3 class="text-lg font-bold text-gray-900 mb-4 flex items-center">
                ...
                <div class="grid grid-cols-2 gap-2 mb-4">
                    ...
                    <div class="payment-method-card" data-provider="cmi" onclick="selectPaymentMethod('cmi')">
                        <div
                            class="flex items-center justify-between p-2 border-2 border-gray-200 rounded-lg hover:border-blue-500 transition-all duration-300 cursor-pointer">
                            <div class="flex items-center">
                                <div
                                    class="w-8 h-8 bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg flex items-center justify-center mr-2">
                    ...
                    <div class="payment-method-card" data-provider="stripe" onclick="selectPaymentMethod('stripe')">
                        <div
                            class="flex items-center justify-between p-2 border-2 border-gray-200 rounded-lg hover:border-purple-500 transition-all duration-300 cursor-pointer">
                            <div class="flex items-center">
                                <div
                                    class="w-8 h-8 bg-gradient-to-r from-purple-600 to-purple-800 rounded-lg flex items-center justify-center mr-2">
        ...
        <div class="fixed top-4 left-4 right-4 z-40 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-2 border border-green-200 shadow-lg backdrop-blur-sm"
            id="cost-calculation-card">
            ...
            <div id="detailed-breakdown" class="hidden mt-1 space-y-0.5 text-xs">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="font-semibold text-green-600"
                        id="activation-fee-display">{{ number_format($pricingPlan->activation_fee ?? 0, 2) }}
                        {{ $currency ?? 'EUR' }}</span>
                </div>
        ...
        <div class="mobile-content" style="padding-top: 120px;">
            ...
            <div class="app-card app-fade-in">
                ...
                <div class="mobile-custom-input">
                    ...
                    <div class="mobile-time-input">
                        <input type="number" id="custom-value" min="10" step="10" placeholder="Ex: 10, 20, 30...">
            ...
            <div class="app-card app-fade-in">
                ...
                <div class="mobile-custom-input">
                    ...
                    <div class="mobile-time-input">
                        <input type="time" id="custom-time" min="06:00" max="22:00" value="{{ date('H:i') }}">
                    ...
                    <div class="mobile-time-slots">
                        @foreach($timeSlots as $slot)
                            <div class="mobile-time-slot {{ $slot['available'] ? 'available' : 'unavailable' }}"
                                data-time="{{ $slot['time'] }}" data-available="{{ $slot['available'] ? 'true' : 'false' }}">
    ...
    <div id="customAlertOverlay" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-lg p-6 max-w-sm w-full mx-4 shadow-xl" id="alertContainer">
            ...
            <div class="flex justify-center space-x-3">
                <button id="customAlertPrimaryBtn"
                    class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors"></button>
                <button id="customAlertSecondaryBtn"
                    class="px-4 py-2 bg-gray-300 text-gray-700 rounded hover:bg-gray-400 transition-colors hidden"></button>
            </div>
        </div>
    </div>
