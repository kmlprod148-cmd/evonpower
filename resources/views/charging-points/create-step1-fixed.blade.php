...
document.addEventListener('DOMContentLoaded', function() {
    // setTimeout supprimé pour éviter les conflits
            // setTimeout supprimé pour éviter les conflits
        }
    }, 1000);
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function searchAddress(query) {
        ...
        searchTimeout = // setTimeout supprimé pour éviter les conflits
        showSearchLoading();
...
<!-- Scripts problématiques supprimés pour éviter les conflits -->
