    ...
    <main class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/80 dark:border-gray-800/80 shadow-sm">
                <form action="{{ route('charging-points.create.store.step1') }}" method="POST" id="step1Form" novalidate>
                    @csrf
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <!-- Group -->
                            <div>
                                <label for="group_id" class="flex items-center gap-1.5 text-sm font-medium text-gray-700 dark:text-gray-300">
