...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
        <h1 class="h3 mb-0"><i class="bi bi-clock-history"></i> Historique des commandes</h1>
        <a href="{{ route('admin.orders.index') }}" class="btn btn-outline-primary"><i class="bi bi-bag-check"></i> Commandes en attente</a>
    </div>
    ...
    <form method="GET" class="row g-3 mb-4 bg-light p-3 rounded shadow-sm">
        ...
        <div class="col-md-3 align-self-end d-flex gap-2">
            ...
            <a href="{{ route('admin.orders.history') }}" class="btn btn-secondary w-100"><i class="bi bi-arrow-clockwise"></i> Réinitialiser</a>
        </div>
    </form>
