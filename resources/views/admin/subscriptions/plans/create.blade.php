...
<div class="space-y-5"
     x-data="planForm({
         ...
         vatRateId: '{{ old('vat_rate_id', '') }}',
         planName: '{{ old('name', '') }}',
         allowRenewal: {{ old('allow_renewal', 1) ? 'true' : 'false' }},
            ...
            <div class="flex items-center gap-3 min-w-0">
                ...
                <div class="min-w-0">
                    <nav class="flex items-center gap-1 text-xs text-gray-400 dark:text-gray-500 mb-0.5">
                        ...
                        <span>Plans</span>
                        <i class="fas fa-chevron-right text-[9px]"></i>
                        <span class="text-gray-600 dark:text-gray-300">Nouveau</span>
                    </nav>
                    <h1 class="text-lg font-bold text-gray-900 dark:text-white truncate">Nouveau plan d'abonnement</h1>
                </div>
            </div>
    ...
    <form id="plan-form" method="POST" action="{{ route('admin.subscriptions.plans.store') }}">
        @csrf
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
            ...
            <div class="lg:col-span-2 space-y-5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" id="name" name="name"
                                       ...
                                       x-model="planName"
                                       placeholder="Ex: Forfait Mensuel Essentiel"
                                       class="w-full px-3 py-2 border @error('name') border-red-400 @else border-gray-300 dark:border-gray-600 @enderror rounded-lg text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-eco-green-500 focus:border-eco-green-500">
                                @error('name')
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-400">Plus petit = affiché en premier</p>
                            </div>
                        </div>
                        {{-- Description --}}
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3"
                                      ...
                                      class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-eco-green-500 focus:border-eco-green-500 resize-none">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </div>
                            ...
                            <div>
                                ...
                                <select id="vat_rate_id" name="vat_rate_id"
                                    ...
                                    @foreach($vatRates as $vr)
                                        <option value="{{ $vr->id }}"
                                                data-rate="{{ $vr->rate }}"
                                                {{ old('vat_rate_id') == $vr->id ? 'selected' : '' }}>
                                            {{ $vr->name }} ({{ $vr->rate }}%)
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div x-show="!vatRateId">
                                ...
                                <div class="relative">
                                    <input type="number" id="vat_rate" name="vat_rate"
                                           value="{{ old('vat_rate', 0) }}" step="0.01" min="0" max="100"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" id="cancellation_fee" name="cancellation_fee"
                                           value="{{ old('cancellation_fee') }}" step="0.01" min="0"
                            ...
                            <div class="grid grid-cols-3 gap-3 text-center">
                                <div>
                                    ...
                                    <p class="text-lg font-bold text-gray-900 dark:text-white"
                                       x-text="formatCurrency(priceHT)">€0.00</p>
                                </div>
                                <div>
                                    ...
                                    <p class="text-lg font-bold text-amber-600 dark:text-amber-400"
                                       x-text="formatCurrency(vatAmount)">€0.00</p>
                                </div>
                                <div class="bg-eco-green-50 dark:bg-eco-green-900/20 rounded-lg p-2">
                                    ...
                                    <p class="text-lg font-bold text-eco-green-700 dark:text-eco-green-300"
                                       x-text="formatCurrency(priceTTC)">€0.00</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                {{-- ③ Quotas (conditional on type) --}}
                <div x-show="showAnyQuota"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div x-show="showSessionQuota"
                                ...
                                <input type="number" id="max_sessions" name="max_sessions"
                                       value="{{ old('max_sessions') }}" min="0" placeholder="Illimité"
                                ...
                                <p class="mt-1 text-xs text-gray-400">Pour les plans par recharge/session</p>
                            </div>
                            {{-- kWh --}}
                            <div x-show="showKwhQuota"
                                ...
                                <input type="number" id="max_kwh" name="max_kwh"
                                       value="{{ old('max_kwh') }}" step="0.01" min="0" placeholder="Illimité"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-eco-green-500 focus:border-eco-green-500">
                                <p class="mt-1 text-xs text-gray-400">Pour les plans par kWh</p>
                            </div>
                            {{-- Duration --}}
                            <div x-show="showDurationQuota"
                                ...
                                <input type="number" id="max_duration_minutes" name="max_duration_minutes"
                                       value="{{ old('max_duration_minutes') }}" min="0" placeholder="Illimité"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-eco-green-500 focus:border-eco-green-500">
                                <p class="mt-1 text-xs text-gray-400">Pour les plans par temps</p>
                            </div>
                            {{-- Max Charging Points (always) --}}
                            <div>
                                ...
                                <input type="number" id="max_charging_points" name="max_charging_points"
                                       value="{{ old('max_charging_points') }}" min="0" placeholder="Illimité"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-eco-green-500 focus:border-eco-green-500">
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center gap-2">
                        ...
                        <span class="ml-auto text-xs text-gray-400 dark:text-gray-500">Affiché aux clients</span>
                    </div>
                    <div class="p-6 space-y-3">
                        ...
                        <div class="flex items-center gap-2 pt-1">
                            <input type="text" x-model="newFeature"
                                   ...
                                   placeholder="Ajouter un avantage (ex: Recharge illimitée)…"
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="p-6">
                        <textarea id="terms_conditions" name="terms_conditions" rows="5"
                                  placeholder="Décrivez les conditions d'utilisation, restrictions, politique de remboursement…"
                                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-eco-green-500 focus:border-eco-green-500 resize-none">{{ old('terms_conditions') }}</textarea>
                    </div>
                </div>
            ...
            <div class="space-y-5">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                    <div class="px-5 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center gap-2">
                        ...
                        <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-300">Aperçu</h3>
                    </div>
                    <div class="p-5">
                        <div class="rounded-xl bg-gradient-to-br from-eco-green-50 to-teal-50 dark:from-eco-green-900/20 dark:to-teal-900/20 border border-eco-green-200 dark:border-eco-green-800/50 p-4">
                            ...
                            <div class="mt-3 flex flex-wrap gap-1.5">
                                ...
                                <template x-if="allowRenewal">
                                    <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-medium bg-blue-100 text-blue-700">
                                        <i class="fas fa-sync text-[9px]"></i> Renouvelable
                                    </span>
                                </template>
                            </div>
                        </div>
                                ...
                                @foreach($chargingPoints as $cp)
                                    <label class="flex items-center gap-2.5 px-3 py-2 hover:bg-gray-50 dark:hover:bg-gray-700/50 cursor-pointer">
                                        <input type="checkbox" name="charging_point_ids[]" value="{{ $cp->id }}"
                                               {{ in_array($cp->id, old('charging_point_ids', [])) ? 'checked' : '' }}
                                               class="rounded border-gray-300 text-eco-green-600 focus:ring-eco-green-500">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="p-5 space-y-1">
                        ...
                        <label class="flex items-center justify-between py-2.5 cursor-pointer group">
                            <div>
                                <p class="text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-eco-green-600 transition-colors">Plan actif</p>
                            ...
                            <div class="relative flex-shrink-0 ml-3">
                                <input type="checkbox" name="is_active" value="1"
                                       ...
                                       x-model="isActive"
                                       class="sr-only peer">
                                <div class="w-10 h-5 bg-gray-200 dark:bg-gray-600 peer-checked:bg-eco-green-500 rounded-full transition-colors cursor-pointer peer-focus:ring-2 peer-focus:ring-eco-green-400"></div>
                                <div class="absolute top-0.5 left-0.5 w-4 h-4 bg-white rounded-full shadow transition-transform peer-checked:translate-x-5"></div>
                            </div>
                        </label>
                        {{-- Featured --}}
                        <input type="hidden" name="is_featured" value="0">
                        <label class="flex items-center justify-between py-2.5 cursor-pointer group border-t border-gray-100 dark:border-gray-700">
                            <div>
                                <p class="text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-amber-600 transition-colors">Mis en avant</p>
                            ...
                            <div class="relative flex-shrink-0 ml-3">
                                <input type="checkbox" name="is_featured" value="1"
                                       ...
                                       x-model="isFeatured"
                                       class="sr-only peer">
                                <div class="w-10 h-5 bg-gray-200 dark:bg-gray-600 peer-checked:bg-amber-400 rounded-full transition-colors cursor-pointer peer-focus:ring-2 peer-focus:ring-amber-300"></div>
                                <div class="absolute top-0.5 left-0.5 w-4 h-4 bg-white rounded-full shadow transition-transform peer-checked:translate-x-5"></div>
                            </div>
                        </label>
                        {{-- Allow Renewal --}}
                        ...
                        <label class="flex items-center justify-between py-2.5 cursor-pointer group border-t border-gray-100 dark:border-gray-700">
                            ...
                            <div class="relative flex-shrink-0 ml-3">
                                <input type="checkbox" name="allow_renewal" value="1"
                                       {{ old('allow_renewal', true) ? 'checked' : '' }}
                        ...
                        <label class="flex items-center justify-between py-2.5 cursor-pointer group border-t border-gray-100 dark:border-gray-700">
                            <div>
                                ...
                                <p class="text-xs text-gray-400">Upgrade vers un plan supérieur autorisé</p>
                            </div>
                            <div class="relative flex-shrink-0 ml-3">
                                <input type="checkbox" name="allow_upgrade" value="1"
                                       {{ old('allow_upgrade') ? 'checked' : '' }}
                                       class="sr-only peer">
                                <div class="w-10 h-5 bg-gray-200 dark:bg-gray-600 peer-checked:bg-blue-500 rounded-full transition-colors cursor-pointer"></div>
                                <div class="absolute top-0.5 left-0.5 w-4 h-4 bg-white rounded-full shadow transition-transform peer-checked:translate-x-5"></div>
                            </div>
                        ...
                        <label class="flex items-center justify-between py-2.5 cursor-pointer group border-t border-gray-100 dark:border-gray-700">
                            <div>
                                ...
                                <p class="text-xs text-gray-400">Downgrade vers un plan inférieur autorisé</p>
                            </div>
                            <div class="relative flex-shrink-0 ml-3">
                                <input type="checkbox" name="allow_downgrade" value="1"
                                       {{ old('allow_downgrade') ? 'checked' : '' }}
                                       class="sr-only peer">
                                <div class="w-10 h-5 bg-gray-200 dark:bg-gray-600 peer-checked:bg-blue-500 rounded-full transition-colors cursor-pointer"></div>
                                <div class="absolute top-0.5 left-0.5 w-4 h-4 bg-white rounded-full shadow transition-transform peer-checked:translate-x-5"></div>
                            </div>
...
function planForm(config) {
    ...
    return {
        ...
        get showAnyQuota()      { return this.showSessionQuota || this.showKwhQuota || this.showDurationQuota || true; },
        ...
        onVatSelect(event) {
            ...
            if (opt && opt.dataset.rate) {
                this.vatRate = parseFloat(opt.dataset.rate);
            }
        },
        addFeature() {
