...
<div class="py-6">
    ...
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-2xl font-medium">Nouveau partenaire</h1>
    </div>
    ...
    <form action="{{ route('integrator.partners.store') }}" method="POST" class="space-y-6">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="type" id="type" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500">
                        ...
                        <option value="Opérateur" {{ old('type') == 'Opérateur' ? 'selected' : '' }}>Opérateur</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="country" id="country" value="{{ old('country', 'Maroc') }}" 
                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500">
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label for="integrator_id" class="block text-sm font-medium text-gray-700 mb-2">Intégrateur responsable *</label>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            <h2 class="text-lg font-medium mb-4">Créer un compte utilisateur</h2>
            
            <div class="space-y-4">
                <div class="flex items-start">
                    <input type="checkbox" name="create_admin_user" id="create_admin_user" value="1" 
                           {{ old('create_admin_user') ? 'checked' : '' }}
                           class="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded mt-1"
                           onchange="toggleUserFields(this)">
                    <label for="create_admin_user" class="ml-2 block text-sm text-gray-900">
                        Créer un compte utilisateur pour ce partenaire
                    </label>
                </div>
                
                <div id="user-fields" class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4" style="display: {{ old('create_admin_user') ? 'grid' : 'none' }};">
                    <div>
                        <label for="admin_name" class="block text-sm font-medium text-gray-700 mb-2">Nom de l'utilisateur *</label>
                        <input type="text" name="admin_name" id="admin_name" value="{{ old('admin_name') }}" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500">
                        <p class="mt-1 text-xs text-gray-500">Nom complet de l'utilisateur administrateur</p>
                    </div>
                    
                    <div>
                        <label for="admin_email" class="block text-sm font-medium text-gray-700 mb-2">Email de l'utilisateur *</label>
                        <input type="email" name="admin_email" id="admin_email" value="{{ old('admin_email') }}" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500">
                        <p class="mt-1 text-xs text-gray-500">Email unique pour la connexion</p>
                    </div>
                    
                    <div>
                        <label for="admin_password" class="block text-sm font-medium text-gray-700 mb-2">Mot de passe *</label>
                    ...
                    <div>
                        <label for="admin_password_confirmation" class="block text-sm font-medium text-gray-700 mb-2">Confirmer le mot de passe *</label>
        ...
        <script>
            function toggleUserFields(checkbox) {
                ...
                const fields = userFields.querySelectorAll('input');
