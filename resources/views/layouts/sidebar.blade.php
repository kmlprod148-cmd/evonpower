...
@endphp
            @if($isAdminNavUser || auth()->user()->can('view_business_profiles'))
            <a href="{{ route($isAdminNavUser ? 'admin.business-profiles.index' : 'business-profiles.index') }}" 
               class="nav-item {{ request()->routeIs('admin.business-profiles.*') || request()->routeIs('business-profiles.*') ? 'active' : '' }}">
                <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="{{ route('charging-points.index') }}" 
               class="nav-item {{ request()->routeIs('charging-points.*') ? 'active' : '' }}">
                ...
                <span class="sidebar-text" x-show="!sidebarCollapsed">Points de charges</span>
            </a>
            @endcan

            <!-- Steve API -->
            @can('view_charging_points')
            @if(\Illuminate\Support\Facades\Route::has('steve-charging-points.index'))
            <a href="{{ route('steve-charging-points.index') }}" 
               class="nav-item {{ request()->routeIs('steve-charging-points.*') ? 'active' : '' }}">
                <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                </svg>
                <span class="sidebar-text" x-show="!sidebarCollapsed">Steve API</span>
            </a>
            @endif
            @endcan
            ...
            <a href="{{ route('withdrawal-requests.index') }}" 
               class="nav-item {{ request()->routeIs('withdrawal-requests.*') ? 'active' : '' }}">
                <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/>
                </svg>
                <span class="sidebar-text" x-show="!sidebarCollapsed">Demandes de retrait</span>
            </a>
            @endcan
            ...
            <a href="{{ route('refunds.index') }}" 
               class="nav-item {{ request()->routeIs('refunds.*') ? 'active' : '' }}">
                <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 15v-1a4 4 0 00-4-4H8m0 0l3 3m-3-3l3-3m9 14V5a2 2 0 00-2-2H6a2 2 0 00-2 2v16l4-2 4 2 4-2 4 2z"/>
                </svg>
                <span class="sidebar-text" x-show="!sidebarCollapsed">Remboursements</span>
            </a>
            @endcan
        </div>

        <!-- Settings Section -->
        <div class="nav-section mt-8 pt-8 border-t border-gray-200 dark:border-gray-700" x-show="!sidebarCollapsed">
