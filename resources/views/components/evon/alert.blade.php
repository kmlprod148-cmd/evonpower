...
@php
    $typeClasses = [
        'success' => 'evon-alert-success',
        'warning' => 'evon-alert-warning',
        'danger' => 'evon-alert-danger',
        'info' => 'evon-alert-info',
    ];
...
<div {{ $attributes->merge(['class' => $alertClass]) }} 
    ...
    <div class="evon-alert-content">
        @if($title)
            <p class="evon-alert-title">{{ $title }}</p>
        @endif
        
        <div class="evon-alert-message">
            {{ $slot }}
        </div>
    </div>
