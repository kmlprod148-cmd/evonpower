...
<body class="bg-gray-100 p-8">
    <div class="max-w-4xl mx-auto">
        <h1 class="text-3xl font-bold mb-8">Language Test Page</h1>
        ...
        <div class="bg-white p-6 rounded-lg shadow mb-6">
            ...
            @include('components.cookie-language-switcher')
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow mb-6">
            ...
            <div class="flex space-x-4">
                <a href="/lang-switch/fr" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">French (FR)</a>
                <a href="/lang-switch/en" class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600">English (EN)</a>
                <a href="/lang-switch/ar" class="px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600">Arabic (AR)</a>
            </div>
        </div>
