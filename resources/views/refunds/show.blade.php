...
@section('title', __('Remboursement') . ' #' . $id)
@section('page-title', __('Détails Remboursement'))
...
<div class="space-y-6">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('Remboursement #') }}{{ $id }}</h1>
            </div>
    ...
    <div class="max-w-lg">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8 text-center">
            <i class="fas fa-undo text-4xl text-gray-300 dark:text-gray-600 mb-4"></i>
            <p class="text-gray-500 dark:text-gray-400">{{ __('Détails du remboursement #') }}{{ $id }}</p>
        </div>
    </div>
</div>
@endsection
