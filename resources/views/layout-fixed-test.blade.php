{{-- Page de test du layout fixe - Sidebar corrigée --}}
@extends('layouts.app-fixed')

@section('title', 'Test Layout Fixe - EVON')
@section('description', 'Test du layout fixe avec sidebar corrigée et pas d\'espace blanc')

@section('content')
<div class="w-full">
    <!-- Test du layout fixe -->
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-6">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Test Layout Fixe - Sidebar Corrigée</h2>
        <p class="text-gray-600 dark:text-gray-300 mb-4">
            Cette page teste le layout fixe avec sidebar corrigée et pas d'espace blanc à gauche.
        </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <h3 class="font-semibold text-gray-800 dark:text-gray-200 mb-2">Sidebar Corrigée</h3>
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <h3 class="font-semibold text-gray-800 dark:text-gray-200 mb-2">Layout Fixe</h3>
                <ul class="text-gray-600 dark:text-gray-300 text-sm space-y-1">
                    <li>• Structure corrigée</li>
                    <li>• CSS optimisé</li>
