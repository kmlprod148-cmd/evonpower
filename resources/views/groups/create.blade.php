    ...
    <div class="p-6 md:p-10">
        @if(session('error'))
            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4" role="alert">
                ...
                <a href="{{ route('groups.create.step1') }}" class="font-semibold underline ml-2">Retour au formulaire précédent</a>
            </div>
        @endif
        <!-- Progress Indicator -->
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <label class="group-type-label @if(old('type', 'private') == 'private') selected @endif">
                        ...
                        <div class="border rounded-lg p-6 transition-all 
                            ...
                            <div class="flex items-center mb-4">
                                <div class="mr-4">
                                    <img src="{{ asset('images/private.png') }}" 
                                         alt="Private Group" 
                            ...
                            <p class="text-sm text-gray-600">
                                Idéal pour les entreprises, associations, hôtels ou parkings souhaitant gérer leurs bornes de recharge et leurs flottes de véhicules électriques.
                            </p>
                        </div>
                    </label>
                    ...
                    <label class="group-type-label @if(old('type') == 'public') selected @endif">
                        ...
                        <div class="border rounded-lg p-6 transition-all 
                            ...
                            <div class="flex items-center mb-4">
                                <div class="mr-4">
                                    <img src="{{ asset('images/public.png') }}" 
                                         alt="Public Group" 
                                         class="w-24 h-24 object-contain">
                                </div>
                                <div>
                            ...
                            <p class="text-sm text-gray-600">
                                Adapté pour les espaces publics, les collectivités et les zones de recharge ouvertes à tous.
                            </p>
                        </div>
                    </label>
                </div>
