                        ...
                        <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                            ...
                            <div id="map-container" class="mt-3 rounded-2xl border border-gray-200 dark:border-gray-800 overflow-hidden shadow-sm">
                                <div id="map" class="w-full relative" style="height: 320px; min-height: 320px;">
                                    ...
                                    <div id="map-placeholder" class="absolute inset-0 flex items-center justify-center bg-gray-50 dark:bg-gray-900 z-10">
...
document.addEventListener('DOMContentLoaded', function() {
    if (latEl && lngEl && latEl.value && lngEl.value) {
        ...
        // Auto-load map with default coordinates only if not already initialized
        if (!mapInitialized) {
            setTimeout(() => {
