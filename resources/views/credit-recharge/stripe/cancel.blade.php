...
<div class="bg-gray-50 dark:bg-gray-900 min-h-screen flex items-center justify-center">
    <div class="max-w-2xl w-full bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 m-4">
        <div class="text-center">
            ...
            <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Paiement Annulé</h1>
            <p class="mt-3 text-lg text-gray-600 dark:text-gray-400">Le processus de paiement a été annulé.</p>
            <p class="mt-1 text-sm text-gray-500">Vous n'avez pas été débité.</p>
        </div>
