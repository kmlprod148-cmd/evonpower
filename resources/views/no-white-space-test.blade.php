{{-- Page de test - Pas d'espace blanc --}}
@extends('layouts.app-no-white-space')

@section('title', 'Test - Pas d\'Espace Blanc - EVON')
@section('description', 'Test du layout sans espace blanc à gauche du contenu principal')

@section('content')
<div class="w-full">
    <!-- Test du layout sans espace blanc -->
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-6">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Test - Pas d'Espace Blanc</h2>
        <p class="text-gray-600 dark:text-gray-300 mb-4">
            Cette page teste le layout sans espace blanc à gauche du contenu principal.
        </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <h3 class="font-semibold text-gray-800 dark:text-gray-200 mb-2">Layout Corrigé</h3>
                <ul class="text-gray-600 dark:text-gray-300 text-sm space-y-1">
                    <li>• Pas d'espace blanc</li>
                    <li>• Sidebar fixe</li>
                    <li>• Contenu responsive</li>
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                ...
                <ul class="text-gray-600 dark:text-gray-300 text-sm space-y-1">
                    <li>• Mobile: Pas de marge</li>
                    <li>• Desktop: Marge adaptée</li>
...
function updateStatus() {
    ...
    const main = document.querySelector('.main-no-white-space');
    if (main) {
