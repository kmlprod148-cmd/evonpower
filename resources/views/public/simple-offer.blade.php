                        ...
                        <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-medium">{{ ucfirst($data['activePricingPlan']->rate_type ?? 'mixte') }}</span>
                                </div>
                                ...
                                @if(isset($data['activePricingPlan']->description) && $data['activePricingPlan']->description)
                                <div class="mt-3 p-3 bg-white rounded border">
                                    <p class="text-sm text-gray-700">{{ $data['activePricingPlan']->description }}</p>
                                </div>
                                @endif
                            </div>
                        </div>
