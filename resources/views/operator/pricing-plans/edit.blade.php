...
@section('title', 'Modifier le Plan Tarifaire')

@section('content')
<div class="container mx-auto px-4 py-6">
    <div class="max-w-4xl mx-auto">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900">Modifier le Plan Tarifaire</h1>
            <p class="mt-1 text-sm text-gray-600">
                Modifiez les informations de votre plan tarifaire.
            </p>
        </div>
        ...
        <form action="{{ route('operator.pricing-plans.update', $pricingPlan) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $pricingPlan->name) }}" 
                    ...
                    <div>
                        ...
                        <input type="number" name="base_price" id="base_price" value="{{ old('base_price', $pricingPlan->base_price) }}" 
                ...
                <div class="mt-6">
                    ...
                    <textarea name="description" id="description" rows="3" 
                              class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('description') border-red-300 @enderror">{{ old('description', $pricingPlan->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="number" name="price_per_kwh" id="price_per_kwh" value="{{ old('price_per_kwh', $pricingPlan->price_per_kwh) }}" 
                    ...
                    <div>
                        ...
                        <input type="number" name="price_per_minute" id="price_per_minute" value="{{ old('price_per_minute', $pricingPlan->price_per_minute) }}" 
                ...
                <div class="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <input type="number" name="connection_fee" id="connection_fee" value="{{ old('connection_fee', $pricingPlan->connection_fee) }}" 
                    ...
                    <div>
                        ...
                        <input type="number" name="minimum_fee" id="minimum_fee" value="{{ old('minimum_fee', $pricingPlan->minimum_fee) }}" 
                    ...
                    <div>
                        ...
                        <input type="number" name="maximum_fee" id="maximum_fee" value="{{ old('maximum_fee', $pricingPlan->maximum_fee) }}" 
                ...
                <div class="space-y-4">
                    <div class="flex items-center">
                        <input type="checkbox" name="is_public" id="is_public" value="1" 
                               {{ old('is_public', $pricingPlan->is_public) ? 'checked' : '' }}
            ...
            <div class="flex justify-end space-x-3">
                <a href="{{ route('operator.pricing-plans.show', $pricingPlan) }}" 
