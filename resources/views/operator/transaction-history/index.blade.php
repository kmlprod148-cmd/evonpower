...
@section('title', 'Historique des Transactions - Opérateur')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <!-- Filtres -->
                <div class="card-body">
                    <form method="GET" action="{{ route('operator.transaction-history.index') }}" class="mb-4">
                        <div class="row">
                            <div class="col-md-3">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-3">
                            <div class="info-box bg-info">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Mes Transactions</span>
                        ...
                        <div class="col-md-3">
                            <div class="info-box bg-success">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Mes Crédits</span>
                        ...
                        <div class="col-md-3">
                            <div class="info-box bg-danger">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Mes Débits</span>
                        ...
                        <div class="col-md-3">
                            <div class="info-box {{ $summary['net_balance'] >= 0 ? 'bg-success' : 'bg-warning' }}">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Mon Solde</span>
...
function exportTransactions(format) {
    const url = new URL('{{ route("operator.transaction-history.export") }}', window.location.origin);
...
function viewTransactionDetails(transactionId) {
    ...
    fetch(`/operator/transaction-history/${transactionId}/details`)
...
function viewReservation(reservationId) {
    window.open(`/operator/reservations/${reservationId}`, '_blank');
}
</script>
@endpush
