...
class TestAdminChargingPointRoute extends Command
{
    protected $signature = 'test:admin-charging-point-route {email}';
    protected $description = 'Test admin charging point route access';
    ...
    public function handle()
    {
        ...
        $this->info("Testing admin charging point route access for user: {$user->name} ({$user->email})");
